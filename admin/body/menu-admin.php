...
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bk">
          <div class="container-fluid"> 
                <a class="navbar-brand" href="../src/home-admin.php"><img src="../../assets/image/logo.png" alt="logotipo" class="logo"></a>
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../src/home-admin.php">Home</a>
                    </li>
                    <?php if($tipo ==! 0): ?>
                      <li class="nav-item">
                        <a class="nav-link" href="../src/chamadas-admin.php">Chamadas</a>
                      </li>
                    <?php endif; ?>

                    <li class="nav-item">
                      <a class="nav-link" href="../src/relatorio-admin.php"> Relatorio</a>
                    </li>
